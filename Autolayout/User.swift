    ...
    static func login(login: String, password: String) -> User? {
     ...
     static let database: Dictionary<String, User> = {
        ...
        for user in [
            ...
            //User(name: "Bad Guy", company: "Hangzhou Qingzhi Network Corp   ", login: "baddie", password: "foo"),
            User(name: "Tom Chen", company: "Hangzhou Qingzhi Network Corp L.T.D", login: "chenjs", password: "foo")
        ] {
